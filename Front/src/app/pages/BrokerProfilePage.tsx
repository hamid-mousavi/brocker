  ...
  if (!broker) {
    return (
      <div className="py-16 text-center">
        ...
        <Link to="/brokers" className="text-blue-600 hover:text-blue-700 mt-4 inline-block">
          بازگشت به لیست
        </Link>
      </div>
    );
  ...
  return (
    <div className="py-4 md:py-8 bg-gray-50 min-h-screen">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <Link
          to="/brokers"
          className="inline-flex items-center gap-2 text-gray-600 hover:text-gray-800 mb-4 md:mb-6 text-sm md:text-base"
        >
          ...
          <div className="p-4 md:p-8">
              ...
              <div className="border border-gray-200 rounded-lg p-3 md:p-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {broker.ports.map((port, index) => (
                    <span key={index} className="bg-blue-100 text-blue-700 px-2 md:px-3 py-1 rounded-full text-xs md:text-sm">
                      {port}
                    </span>
                  ))}
                </div>
              ...
              <div className="border border-gray-200 rounded-lg p-3 md:p-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {broker.services.map((service, index) => (
                    <span key={index} className="bg-green-100 text-green-700 px-2 md:px-3 py-1 rounded-full text-xs md:text-sm">
                      {service}
                    </span>
                  ))}
                </div>
            ...
            <div className="mb-6 md:mb-8">
              ...
              <div className="bg-gray-50 p-3 md:p-4 rounded-lg">
                ...
                <p className="text-lg md:text-xl font-semibold">{broker.mobile}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="grid grid-cols-2 gap-3 md:gap-4">
            <a
              ...
              className="bg-blue-600 text-white px-4 md:px-6 py-3 md:py-4 rounded-lg hover:bg-blue-700 transition flex items-center justify-center gap-2 font-semibold text-sm md:text-base"
            >
              <Phone className="w-4 h-4 md:w-5 md:h-5" />
              تماس تلفنی
            </a>
            <a
              href={`https://wa.me/${broker.whatsapp || broker.mobile}`}
              target="_blank"
              rel="noopener noreferrer"
              className="bg-green-600 text-white px-4 md:px-6 py-3 md:py-4 rounded-lg hover:bg-green-700 transition flex items-center justify-center gap-2 font-semibold text-sm md:text-base"
            >
